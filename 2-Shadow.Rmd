...
Until then, you can find some inspiration for using the Cubeling app in connection with teaching spatial reasoning (in German) at @Ladel:2017, @Bonig:2018, @Pilgrim:2018, @PIKASdigi:2020 or @Rahn:2020.
