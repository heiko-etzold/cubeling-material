...
When you start the app, you will see a split screen, a **3D view** on the left and the **blueprint** on the right.
...
```{r echo=FALSE, fig.cap="App-Einstellungen", fig.align='center', out.width='75%'}
